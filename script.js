...
// // ✅ NEW: Function to split words into chunks of 5-6 words
...
// // ✅ MODIFIED: Build timeline for word chunks
...
//     // ✅ Use new chunk-based timeline
//     const timeline = buildWordTimelineWithChunks(words, 5);
...
//       // ✅ Build text with ONLY current chunk words
...
//       if (gapAfter > 0.01) {
//         console.log(`   ⏸️  Silent period: ${audio_duration.toFixed(2)}s to ${clipDuration.toFixed(2)}s (gap extension)`);
//       }
...
//     console.log(`   🎬 Running FFmpeg with extended duration: ${clipDuration.toFixed(3)}s...`);
